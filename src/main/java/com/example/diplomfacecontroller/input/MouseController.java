...
public class MouseController {
     ...
     * 0 = snap фактически отключён (срабатывал бы только при попадании ровно
     * на край). Именно он раньше "примагничивал" курсор к краю — оставляем 0.
     */
    private static final int EDGE_SNAP_PX = 0;

    /**
     * Минимальный отступ курсора от края экрана (в пикселях).
     * Курсор не подходит к краю ближе чем на EDGE_MARGIN_PX — так он не
     * "залипает" вплотную к границе экрана.
     */
    private static final int EDGE_MARGIN_PX = 6;
